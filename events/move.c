...
/*   Updated: 2025/02/10 14:11:33 by ade-beco         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

static void	move_forward(t_data *data, double distance)
{
	double	new_pos_x;
	double	new_pos_y;
	double	checker_x;
	...
	if ((data->map->matrix)[(int)(data->player->pos.y / data->map->grid_size)] \
		[(int)(checker_x / data->map->grid_size)] != '1')
		data->player->pos.x = new_pos_x;
	if ((data->map->matrix)[(int)(checker_y / data->map->grid_size)] \
		[(int)(data->player->pos.x / data->map->grid_size)] != '1')
		data->player->pos.y = new_pos_y;
}

static void	move_backward(t_data *data, double distance)
{
	double	new_pos_x;
	double	new_pos_y;
	double	checker_x;
...
static void	move_right(t_data *data, double distance)
{
	double	new_pos_x;
	double	new_pos_y;
	double	checker_x;
...
static void	move_left(t_data *data, double distance)
{
	double	new_pos_x;
	double	new_pos_y;
	double	checker_x;
